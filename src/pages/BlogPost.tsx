          ...
          <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="p-8 md:p-16">
              <div className="prose prose-lg prose-slate max-w-none text-slate-700
                ...
                prose-img:rounded-2xl prose-img:mt-12 prose-img:mb-6 prose-img:shadow-lg
                prose-blockquote:border-l-4 prose-blockquote:border-charcoal prose-blockquote:bg-slate-50 prose-blockquote:p-8 prose-blockquote:my-12 prose-blockquote:rounded-r-2xl prose-blockquote:italic prose-blockquote:text-xl prose-blockquote:text-slate-800
                ...
                [&>em]:block [&>em]:text-center [&>em]:text-sm [&>em]:text-slate-500 [&>em]:mb-12 [&>em]:italic
              ">
